...
<center>
	...
	<table border=1>
		...
		<logic:iterate id="Operazione" name="myuserLogin" property="ruolo.operazioni">
 		...
 		<c:if test="${utenteSession.ruolo.descrizione eq 'amministratore' or utenteSession.ruolo.descrizione eq 'superuser'}">
 			<tr><td><a href="gestioneCittadino.do?method=sarch">Anagrafica Cittadini</a></td></tr>
 		</c:if>
 		<c:if test="${utenteSession.ruolo.descrizione eq 'amministratore' or utenteSession.ruolo.descrizione eq 'superuser' or utenteSession.ruolo.descrizione eq 'standard'}">
 		<tr><td><a href="gestioneCittadino.do?method=residenza">Gestione Residenze</a></td></tr>
		</c:if>
