...
public class HelloServiceLocator extends org.apache.axis.client.Service implements it.geek.ws.HelloService {
    ...
    private java.lang.String Hello_address = "http://localhost:8080/HelloWS/services/Hello";
    ...
    public it.geek.ws.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.geek.ws.HelloSoapBindingStub _stub = new it.geek.ws.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.geek.ws.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                it.geek.ws.HelloSoapBindingStub _stub = new it.geek.ws.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ws.geek.it", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ws.geek.it", "Hello"));
        }
