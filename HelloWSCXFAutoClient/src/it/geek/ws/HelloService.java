...
public class HelloService extends Service {
    ...
    public final static QName SERVICE = new QName("http://ws.geek.it/", "HelloService");
    public final static QName HelloPort = new QName("http://ws.geek.it/", "HelloPort");
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/Valerio/Documents/GitHub/music/HelloWSCXFAutoClient/WebContent/wsdl/hello.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/Valerio/Documents/GitHub/music/HelloWSCXFAutoClient/WebContent/wsdl/hello.wsdl");
        }
        WSDL_LOCATION = url;
    }
